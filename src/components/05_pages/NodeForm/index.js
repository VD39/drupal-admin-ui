...
class NodeForm extends React.Component {
  ...
  createField = ({ fieldName, widget, inputProps }) => {
    ...
    const hasMultipleDeltas = (fieldSchema.type && fieldSchema.type === 'array') || (fieldSchema.properties && fieldSchema.properties.data && fieldSchema.properties.data.type === 'array');
